...
endgameBonuses['CIVILIZATION_THP_NORTHYUAN'] = {pop=6, food=4, prod=5, cul=3, sci=7, stg=150, gold=8, mil=6, city=5, grp=1, fai=3, reli=0}
...
endgameBonuses['CIVILIZATION_CL_KULIN'] = {pop=10, food=5, prod=5, cul=5, sci=10, stg=10000, gold=5, mil=10, city=11, grp=5, fai=5, reli=1}
...
endgameBonuses['CIVILIZATION_SENSHI_MARAJO'] = {pop=5, food=4, prod=4, cul=4, sci=6, stg=40, gold=3, mil=5, city=6, grp=4, fai=2, reli=1}

...
endgameBonuses['CIVILIZATION_DENEFIRSTNATION'] = {pop=7, food=3, prod=3, cul=3, sci=7, stg=260, gold=8, mil=5, city=8, grp=3, fai=3, reli=1}
endgameBonuses['CIVILIZATION_JWW_RIO_GRANDE'] = {pop=6, food=3, prod=2, cul=3, sci=6, stg=455, gold=8, mil=5, city=6, grp=2, fai=1, reli=0}
endgameBonuses['CIVILIZATION_EW_NEUTRAL'] = {pop=1, food=0, prod=0, cul=0, sci=0, stg=10, gold=20, mil=0, city=1, grp=0, fai=0, reli=0}
endgameBonuses['CIVILIZATION_SENSHI_MARAJO'] = {pop=3, food=3, prod=3, cul=4, sci=4, stg=40, gold=2, mil=4, city=5, grp=4, fai=2, reli=1}

...
endgameBonuses['CIVILIZATION_MC_GAUL'] = {pop=7, food=4, prod=3, cul=3, sci=7, stg=200, gold=9, mil=8, city=5, grp=3, fai=2, reli=0}
endgameBonuses['CIVILIZATION_GREATEREUROPE_GERMANY'] = {pop=4, food=4, prod=3, cul=3, sci=7, stg=50, gold=11, mil=7, city=7, grp=3, fai=3, reli=0}
...
endgameBonuses['CIVILIZATION_JWW_UZBEKISTAN'] = {pop=2, food=2, prod=2, cul=3, sci=6, stg=200, gold=4, mil=4, city=3, grp=2, fai=4, reli=1}
endgameBonuses['CIVILIZATION_JFD_PUNJAB'] = {pop=6, food=4, prod=4, cul=4, sci=9, stg=1400, gold=13, mil=9, city=9, grp=4, fai=4, reli=1}
endgameBonuses['CIVILIZATION_MC_CHOLA'] = {pop=7, food=3, prod=2, cul=3, sci=9, stg=200, gold=6, mil=5, city=5, grp=1, fai=2, reli=0}
endgameBonuses['CIVILIZATION_EW_PARG'] = {pop=2, food=2, prod=3, cul=3, sci=6, stg=1600, gold=8, mil=6, city=4, grp=2, fai=0, reli=0}
endgameBonuses['CIVILIZATION_THP_NORTHYUAN'] = {pop=4, food=4, prod=5, cul=3, sci=4, stg=1200, gold=6, mil=6, city=6, grp=1, fai=3, reli=0}
endgameBonuses['CIVILIZATION_SENSHI_CHUKCHI'] = {pop=8, food=5, prod=5, cul=4, sci=8, stg=50, gold=17, mil=6, city=8, grp=3, fai=3, reli=0}
endgameBonuses['CIVILIZATION_PB_TAIPING'] = {pop=1, food=1, prod=1, cul=1, sci=0, stg=600, gold=4, mil=1, city=1, grp=0, fai=4, reli=1}
endgameBonuses['CIVILIZATION_ORG_MALACCA'] = {pop=9, food=5, prod=5, cul=5, sci=10, stg=100, gold=25, mil=10, city=10, grp=5, fai=2, reli=0}
endgameBonuses['CIVILIZATION_CL_KULIN'] = {pop=10, food=5, prod=6, cul=5, sci=10, stg=200, gold=32, mil=10, city=11, grp=5, fai=5, reli=1}
endgameBonuses['CIVILIZATION_DENEFIRSTNATION'] = {pop=8, food=4, prod=4, cul=4, sci=8, stg=400, gold=12, mil=9, city=8, grp=4, fai=4, reli=1}
endgameBonuses['CIVILIZATION_JWW_RIO_GRANDE'] = {pop=5, food=4, prod=3, cul=3, sci=6, stg=150, gold=11, mil=6, city=5, grp=2, fai=2, reli=0}
endgameBonuses['CIVILIZATION_EW_NEUTRAL'] = {pop=1, food=1, prod=1, cul=1, sci=1, stg=900, gold=20, mil=1, city=1, grp=0, fai=0, reli=0}
endgameBonuses['CIVILIZATION_SENSHI_MARAJO'] = {pop=6, food=5, prod=4, cul=4, sci=8, stg=200, gold=14, mil=6, city=6, grp=4, fai=4, reli=1}

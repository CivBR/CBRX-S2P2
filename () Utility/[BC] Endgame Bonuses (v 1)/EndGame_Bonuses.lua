...
endgameBonuses['CIVILIZATION_CL_NIGERIA'] = {pop=8, food=5, prod=5, cul=5, sci=10, stg=664, gold=5, mil=10, city=8, grp=4, fai=5, reli=1}
...
endgameBonuses['CIVILIZATION_JFD_PUNJAB'] = {pop=9, food=5, prod=5, cul=3, sci=9, stg=9000, gold=20, mil=10, city=9, grp=4, fai=3, reli=1}
endgameBonuses['CIVILIZATION_MC_CHOLA'] = {pop=4, food=4, prod=3, cul=3, sci=9, stg=727, gold=10, mil=7, city=3, grp=1, fai=2, reli=0}
endgameBonuses['CIVILIZATION_EW_PARG'] = {pop=2, food=2, prod=2, cul=2, sci=5, stg=40, gold=5, mil=2, city=2, grp=2, fai=0, reli=0}
endgameBonuses['CIVILIZATION_THP_NORTHYUAN'] = {pop=6, food=4, prod=5, cul=3, sci=5, stg=150, gold=8, mil=6, city=5, grp=1, fai=3, reli=0}
...
endgameBonuses['CIVILIZATION_CL_KULIN'] = {pop=10, food=5, prod=5, cul=5, sci=10, stg=7000, gold=5, mil=10, city=11, grp=5, fai=5, reli=1}
endgameBonuses['CIVILIZATION_DENEFIRSTNATION'] = {pop=7, food=5, prod=5, cul=5, sci=7, stg=660, gold=8, mil=7, city=8, grp=3, fai=3, reli=1}
...
endgameBonuses['CIVILIZATION_SENSHI_MARAJO'] = {pop=5, food=5, prod=5, cul=5, sci=7, stg=40, gold=3, mil=5, city=6, grp=4, fai=2, reli=1}
